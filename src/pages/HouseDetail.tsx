    ...
    "cift-katli-villa": {
      tr: {
        ...
        details: {
          ...
          icOzellikler: [
            { label: "Doğrama", value: "Metal panjurlu" },
            { label: "Zemin", value: "Seramik" },
            { label: "Salon Zemin", value: "Seramik" },
            { label: "Mutfak Zemin", value: "Seramik" },
      ...
      en: {
        ...
        details: {
          ...
          icOzellikler: [
            { label: "Frames", value: "Metal shutters" },
            { label: "Flooring", value: "Ceramic" },
            { label: "Living Room Floor", value: "Ceramic" },
            { label: "Kitchen Floor", value: "Ceramic" },
      ...
      tr: {
        ...
        details: {
          ...
          icOzellikler: [
            ...
            { label: "Salon Zemin", value: "Seramik" },
            { label: "Mutfak Zemin", value: "Seramik" },
            { label: "Oda Zeminleri", value: "Seramik" },
            { label: "Banyo Zemin", value: "Seramik" },
            { label: "Banyo Duvar", value: "Fayans" },
            { label: "Mutfak", value: "Açık-kapalı mutfak" },
            { label: "Duvar", value: "Ahşap lambri" },
      ...
      en: {
        ...
        details: {
          ...
          icOzellikler: [
            ...
            { label: "Living Room Floor", value: "Ceramic" },
            { label: "Kitchen Floor", value: "Ceramic" },
            { label: "Room Floors", value: "Ceramic" },
            { label: "Bathroom Floor", value: "Ceramic" },
            { label: "Bathroom Wall", value: "Tiles" },
            { label: "Kitchen", value: "Open-closed kitchen" },
            { label: "Wall", value: "Wooden paneling" },
